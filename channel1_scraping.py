...
#directory
new_directory = "/Users/raushanzhandayeva/Desktop/Dissertation/Channel1-text/01. January 2022 - Channel 1" # change this to the directory where the HTML files are stored
...
df.to_excel("01_scraped_ch1_rus_jan22.xlsx", index=False) # change the name of the output file as needed (month)
